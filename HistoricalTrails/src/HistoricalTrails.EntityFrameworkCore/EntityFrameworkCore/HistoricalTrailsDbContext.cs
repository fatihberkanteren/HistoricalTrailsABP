...
public class HistoricalTrailsDbContext :
    AbpDbContext<HistoricalTrailsDbContext>,
    IIdentityDbContext,
    ITenantManagementDbContext
{
    ...
    public HistoricalTrailsDbContext(DbContextOptions<HistoricalTrailsDbContext> options)
        : base(options)
    {
